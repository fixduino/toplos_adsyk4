...
<head>
	<title>Login | Pertamina DPPU Adisucipto</title>
	<meta charset="utf-8">
					...
					<div class="content">
						...
						<form class="form-auth-small" action="index.php">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="uname" value="" placeholder="Username">
							</div>
							<div class="form-group">
								<label for="signin-password" class="control-label sr-only">Password</label>
								<input type="password" class="form-control" id="upass" value="" placeholder="Password">
							</div>
