...
insert  into `tb_tank`(`id`,`tank`,`level`,`pa`,`max_level`,`max_pa`,`status`,`sisipan`,`time`,`deadstok`,`patarget`,`targetstat`) values (1,'T1',42,28487,1000,58972,201,500,'2017-10-28 01:41:00',4000,100,0),(2,'T2',127,46811,2000,58900,101,500,'2017-10-30 08:28:23',2920,200,0),(3,'T3',200,58109,200,58750,101,500,'2017-07-30 06:31:48',3300,300,0),(4,'T4',108,10000,200,57100,202,500,'2017-10-28 02:24:33',3424,9,0),(5,'T5',26,80000,200,99800,102,500,'2017-10-27 23:16:57',3600,500,0),(6,'T6',200,0,200,99000,99,500,'2017-07-30 06:31:48',0,0,0),(7,'T7',176,81386,200,99150,102,500,'2017-10-27 23:14:23',1900,81,0),(8,'T8',189,97520,200,99070,100,500,'2017-10-13 17:51:53',2165,97,0);
...
insert  into `tb_type`(`id`,`type`) values (1,'superuser'),(2,'operator');
...
insert  into `users`(`id`,`username`,`password`,`type`,`foto`) values (1,'admin','d033e22ae348aeb5660fc2140aec35850c4da997','superuser','user.jpg'),(2,'operator','fe96dd39756ac41b74283a9292652d366d73931f','operator',''),(3,'user1','avsavsa','operator','logo.jpg'),(4,'user2','a1881c06eec96db9901c7bbfe41c42a3f08e9cb4','operator','logo.png'),(5,'user4','06e6eef6adf2e5f54ea6c43c376d6d36605f810e','operator','logo.png'),(6,'user3','0b7f849446d3383546d15a480966084442cd2193','operator','logo.png');
